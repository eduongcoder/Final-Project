...
const handleViewChapters = async (novel) => {
  if (selectedNovel === novel) {
  setSelectedNovel(null); // toggle off
} else {
  console.log("idNovel", novel);
  setSelectedNovel(novel);
  // Bạn có thể thêm hàm fetch chương tại đây nếu cần
}
};
